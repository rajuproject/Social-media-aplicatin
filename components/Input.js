    ...
    <div className="flex border-b border-gray-100 p-2 space-x-2">
      ...
      <div className="w-full divide-y divide-gray-200">
        ...
        <div className="flex items-center justify-between p-2 ">
          <div className="flex">
            <PhotoIcon className="h-8 w-10 hoverEffect p-2 text-sky-500 hover:bg-sky-100" />
            <FaceSmileIcon className="h-8 w-10 hoverEffect p-2 text-sky-500 hover:bg-sky-100" />
          </div>
